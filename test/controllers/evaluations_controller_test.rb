...
class EvaluationsControllerTest < ActionController::TestCase
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post :create, evaluation: { name: @evaluation.name, password: @evaluation.password, topic_id: @evaluation.topic_id }
    end
  ...
  test "should update evaluation" do
    patch :update, id: @evaluation, evaluation: { name: @evaluation.name, password: @evaluation.password, topic_id: @evaluation.topic_id }
    assert_redirected_to evaluation_path(assigns(:evaluation))
  end
