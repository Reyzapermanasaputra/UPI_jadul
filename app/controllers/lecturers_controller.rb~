class LecturersController < ApplicationController
  ...
  before_filter :authenticate_user!, except: [:show, :update, :edit]
  # GET /lecturers
  # GET /lecturers.json
  def index
  ...
  private
    ...
    def lecturer_params
      params.require(:lecturer).permit(:nip, :name, :place, :birth, :work_unit, :address, :phone, :email, :password, :password_confirmation, :role_id)
    end
end
