class EvaluationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @evaluation.save
        format.html { redirect_to topic_evaluations_url, notice: 'Evaluation was successfully created.' }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @evaluation.update_attributes(evaluation_params)
        format.html { redirect_to topic_evaluations_path, notice: 'Evaluation was successfully updated.' }
  ...
  private
    ...
    def evaluation_params
      params.require(:evaluation).permit(:name, :password, :topic_id, :questions_attributes => [:id, :text, :_destroy, :choices_attributes =>[:id, :text, :_destroy]])
    end
end
